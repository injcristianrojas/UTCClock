...
build: compile-schemas
	zip utcclock.zip extension.js LICENSE metadata.json prefs.js prefs.ui convenience.js schemas/*

install: compile-schemas
	mkdir -p $(PLUGIN_LOCATION)
	cp -R extension.js LICENSE metadata.json prefs.js prefs.ui convenience.js schemas/ $(PLUGIN_LOCATION)
